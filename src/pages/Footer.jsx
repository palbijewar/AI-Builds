      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="col-span-1">
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">AI Builds</h6>
            <p>
              Crafting digital solutions, our innovative software services website empowers businesses with cutting-edge design and intuitive experiences, fostering confidence in embracing technology's future.
            </p>
          </div>
          {/* Products section */}
          <div className="col-span-1">
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">Products</h6>
            <p className="mb-4">Web Applications</p>
            <p className="mb-4">Software Development</p>
            <p className="mb-4">App Development</p>
            <p>Full Stack Apps</p>
          </div>
          {/* Contact section */}
          <div className="col-span-1">
