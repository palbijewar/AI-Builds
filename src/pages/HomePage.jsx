      ...
      <div className="">
        ...
        <div className="mx-auto max-w-2xl py-40 sm:py-48 lg:py-40">
          <div className="text-center">
            ...
            Transforming visions into digital realities, our software services website is a vibrant hub of innovation, offering cutting-edge solutions tailored to elevate businesses to new heights. With sleek design and intuitive user experiences, we empower clients to embrace the future of technology with confidence and flair.
            </p>
